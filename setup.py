...
setup(
    name="azul-plugin-tika",
    description="Azul plugin for extracting metadata and text using Apache Tika.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_tika"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-tika = azul_plugin_tika.main:main",
        ]
    },
