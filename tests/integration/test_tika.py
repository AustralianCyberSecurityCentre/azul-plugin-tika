    ...
    def test_jpg(self):
        ...
        result = self.do_execution(
            data_in=[
                (
                    "content",
                    self.load_test_file_bytes(
                        "c66effbcfca82fb829aabbd71d5094f8a3b36fb6038e2fa7eee8f0a1ef5b94dd", "JPG file."
                    ),
                )
            ],
        )
        ...
        self.assertJobResult(
            ...
            JobResult(
                ...
                events=[
                    Event(
                        sha256="c66effbcfca82fb829aabbd71d5094f8a3b36fb6038e2fa7eee8f0a1ef5b94dd",
                        features={
                            "dropped_metadata": [
                                FV(
                            ...
                            "file_metadata": [
                                ...
                                FV("0 1 0 0 0 4", label="Layer Selection IDs"),
                                FV("0 2", label="Layer State Information"),
                                FV("0.964 1 0.825", label="ICC:XYZ values"),
                                FV("1", label="tiff:Orientation"),
                                FV("1 (Adobe Photoshop, Adobe Photoshop CS6) 1", label="Version Info"),
                                FV("1.0", label="Pixel Aspect Ratio"),
                                FV("12 (Maximum), Optimised format, 3 scans", label="JPEG Quality"),
                                FV("120", label="Global Angle"),
                                FV("17", label="ICC:Tag Count"),
                                FV("178", label="tiff:ImageWidth"),
                                FV("178 pixels", label="Exif SubIFD:Exif Image Width"),
                                FV("178 pixels", label="Image Width"),
                                FV("19", label="XMP Value Count"),
                                FV(
                                ...
                                FV("2016-11-14T18:52:25", label="dcterms:created"),
                                FV("2016-11-14T18:52:25", label="dcterms:modified"),
                                FV("2016:11:14 18:52:25", label="Exif IFD0:Date/Time"),
                                FV("23", label="Seed Number"),
                                FV("236", label="tiff:ImageLength"),
                                FV("236 pixels", label="Exif SubIFD:Exif Image Height"),
                                FV("236 pixels", label="Image Height"),
                                ...
                                FV("64", label="Flags 0"),
                                FV("70299 bytes", label="File Size"),
                                FV("7109 bytes", label="Exif Thumbnail:Thumbnail Length"),
                                ...
                                FV("Adobe Photoshop CS6 (Windows)", label="Exif IFD0:Software"),
                                FV("Adobe Photoshop CS6 (Windows)", label="tiff:Software"),
                                ...
                                FV(
                                    "JpegRGB, 121x160, Decomp 58240 bytes, 1572865 bpp, 7109 bytes",
                                    label="Thumbnail Data",
                                ),
                                FV("Lino", label="ICC:CMM Type"),
                                FV("Media-Relative Colorimetric", label="ICC:Rendering Intent"),
                                ...
                                FV("[22 values]", label="Layer Groups Enabled ID"),
                                FV("[251 values]", label="Print Info 2"),
                                FV("[44 values]", label="Layers Group Information"),
                                FV("[557 values]", label="Print Style"),
                                ...
                                FV("xmp.did:FB70B0588AAAE611A6F5F2B4A810C7F4", label="xmpMM:DocumentID"),
                                FV("Без назви-1 (0,0,236,178) 1 Slices", label="Slices"),
                            ],
                            "mime": [FV("image/jpeg")],
                        },
                    )
